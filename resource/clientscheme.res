...
Scheme
{
	...
	BaseSettings
	{
		...
		// default; defining them here (mod-first) forces a white look.
...
///HERE
	...
	Fonts
	{
		...
		// HL2SB: small death-icon fonts so the killfeed weapon/skull glyphs draw
		// around text height and sit level with the names (not a big 32px glyph).
		"HL2MPTypeDeathSmall"
		{
		   "1"
		   {
