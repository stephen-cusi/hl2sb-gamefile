...
"modevents"
{
	...
	{
		"entindex_killed"		"long"		// entindex of the killed entity
		"entindex_attacker"		"long"		// entindex of the killer entity (0 if none)
		"entindex_inflictor"	"long"		// entindex of the inflictor entity (0 if none)
		"damagebits"			"long"		// type of damage
		"attacker_uid"			"long"		// userid of killer if it was a player, 0 otherwise
