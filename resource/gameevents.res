...
//
// HL2SB gameevents.res - mod-first copy of the base game events, plus the
// item_pickup event used by the ported GMod pickup HUD.
//
...
//////////////////////////////////////////////////////////////////////
// HL2SB: item pickup (weapon / item / ammo) for the GMod pickup HUD
//////////////////////////////////////////////////////////////////////

	"item_pickup"				// player picked up a weapon/item/ammo
	{
		"userid"	"short"		// user ID on server
